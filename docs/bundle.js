...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aD, request.aR, true);
		} catch (e) {
...
var $author$project$Main$Silence = {$: 0};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2($author$project$Main$Silence, $elm$core$Platform$Cmd$none);
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{as: false, au: r.au, ay: r.ay, S: r.S, aD: r.aD, aO: r.aO, am: r.am, aR: r.aR}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{au: $elm$http$Http$emptyBody, ay: r.ay, S: _List_Nil, aD: 'GET', aO: $elm$core$Maybe$Nothing, am: $elm$core$Maybe$Nothing, aR: r.aR});
};
var $author$project$Main$loadDay = function (dayNum) {
	...
	return _Utils_Tuple2(
		...
		$elm$http$Http$get(
			{
				ay: $elm$http$Http$expectString($author$project$Main$GotText),
				aR: url
			}));
};
...
var $author$project$Day1$part1 = function (text) {
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 1) {
			var n = msg.a;
			return $author$project$Main$loadDay(n);
		} else {
			var result = msg.a;
			if (!result.$) {
				var inputData = result.a;
				var answer = $author$project$Day1$part1(inputData);
				return _Utils_Tuple2(
					$author$project$Main$Success(answer),
...
var $author$project$Main$viewAnswer = function (model) {
	switch (model.$) {
		case 0:
			return $elm$html$Html$text('');
		case 1:
			return $elm$html$Html$text('Sorry, can\'t load input data.');
		case 2:
			return $elm$html$Html$text('Loading...');
		default:
			var answer = model.a;
			return $elm$html$Html$text(answer);
	}
};
var $author$project$Main$LoadDay = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Main$viewDayButtons = function (n) {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$LoadDay(i))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(
					'Solve Day ' + $elm$core$String$fromInt(i))
				]));
	};
	return A2(
		$elm$core$List$map,
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		A2(
			...
			$author$project$Main$viewDayButtons(0),
			_List_fromArray(
				[
					$author$project$Main$viewAnswer(model)
				])));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{aC: $author$project$Main$init, aN: $author$project$Main$subscriptions, aQ: $author$project$Main$update, aS: $author$project$Main$view});
